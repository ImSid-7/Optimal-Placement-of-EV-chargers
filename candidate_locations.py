...
# load data
with open(r'Data_1.csv', 'r') as nodecsv: # Open the file
...
with open(r'data-optimization.csv', 'r') as nodecsv: # Open the file
    nodereader = csv.reader(nodecsv) # Read the csv
...
for node in dataset:
    #print(congestion_probabilities)
    #print(dataset)
    #print(congestion)
    base_prob = congestion_probabilities['School'] # get the probability that the area is congested from congestion_probabilities dicitonary
...
for node in dataset:
    ...
    congest_val = congestion_probabilities['Residential']
